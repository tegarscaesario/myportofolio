...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Kick off render loop on first mouse/touch move
    const handleFirstMove = e => {
      let pointer = pointers[0];
      let posX = scaleByPixelRatio(e.clientX ?? e.targetTouches[0].clientX);
      let posY = scaleByPixelRatio(e.clientY ?? e.targetTouches[0].clientY);
      let color = generateColor();
      updateFrame();
      updatePointerMoveData(pointer, posX, posY, color);
      document.body.removeEventListener('mousemove', handleFirstMove);
      document.body.removeEventListener('touchstart', handleFirstMove);
    };

    document.body.addEventListener('mousemove', handleFirstMove);
    document.body.addEventListener('touchstart', handleFirstMove);
